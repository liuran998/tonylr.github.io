...
PhD candidate in Computer Science at Singapore Management University, supported by the A STAR Graduate Scholarship (AGS). My research centers on machine learning for Knowledge Graphs, with a strong focus on few-shot relation learning, multimodal learning, and meta-learning. I aim to advance knowledge representation and reasoning by integrating structured graph data with unstructured modalities such as text and images. I am particularly interested in enhancing graph-based models with Pretrained Language Models(PLMs) & Large Language Models (LLMs) like BERT, LLaMA, and other cutting-edge architectures to improve machine understanding and inference in low-resource settings. My research is supervised by Prof. [Fang Yuan](https://www.yfang.site/curriculum-vitae) and co-supervised by Prof. [Xiaoli Li](https://personal.ntu.edu.sg/xlli/), affiliated with the Institute for Infocomm Research at A*Star, Singapore. Prior to my doctoral studies, I obtained a Master’s degree in Analytics from Nanyang Technological University (NTU) in 2020.
...
[Context-Aware Adapter Tuning for Few-Shot Relation Learning in Knowledge Graphs](https://aclanthology.org/2024.emnlp-main.970/)
